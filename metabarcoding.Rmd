...
p <- m_clr_scores %>%
    ...
    labs(color = "Seasons", fill = "Fluorescence") +
...
Here on out are just playground and lots of junk code for playing around with models and our data.
